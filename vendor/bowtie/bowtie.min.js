...
(function(){var t,e,n,o,r,i,u,s,a,l,c,h,d,p,f,m,v,y,g,E,w,b,k,_,T,S,H,A,x,C,L,N,R,O,q,F,X,D,I,M,P,j,G,U,B,$,K,Q,V,Y,z,J,W,Z,te,ee,ne,oe,re=[].indexOf||function(t){for(var e=0,n=this.length;n>e;e++)if(e in this&&this[e]===t)return e;return-1},ie={}.hasOwnProperty,ue=function(t,e){function n(){this.constructor=t}for(var o in e)ie.call(e,o)&&(t[o]=e[o]);return n.prototype=e.prototype,t.prototype=new n,t.__super__=e.prototype,t},se=[].slice,ae=function(t,e){return function(){return t.apply(e,arguments)}};q={},d=10,W=!1,M=null,E=null,R=null,j=null,ne=null,o={BEFORE_CHANGE:"page:before-change",FETCH:"page:fetch",RECEIVE:"page:receive",CHANGE:"page:change",UPDATE:"page:update",LOAD:"page:load",RESTORE:"page:restore",BEFORE_UNLOAD:"page:before-unload",EXPIRE:"page:expire"},J=function(t){return t},v=function(t){return J=t},T=function(t){var e;return t=new n(t),K(),h(),null!=M&&M.start(),W&&(e=Z(t.absolute))?(S(e),H(t,null,!1)):H(t,Y)},Z=function(t){var e;return e=q[t],e&&!e.transitionCacheDisabled?e:void 0},b=function(t){return null==t&&(t=!0),W=t},w=function(t){return null==t&&(t=!0),l?t?null!=M?M:M=new i("html"):(null!=M&&M.uninstall(),M=null):void 0},H=function(t,e,n){return null==n&&(n=!0),te(o.FETCH,{url:t.absolute}),null!=ne&&ne.abort(),ne=new XMLHttpRequest,ne.open("GET",t.withoutHashForIE10compatibility(),!0),ne.setRequestHeader("Accept","text/html, application/xhtml+xml, application/xml"),ne.setRequestHeader("X-XHR-Referer",j),ne.onload=function(){var n;return te(o.RECEIVE,{url:t.absolute}),(n=I())?(t.pathname.match(/\.hbs$/)||(G(t),U()),p.apply(null,_(n)),O(),"function"==typeof e&&e(),te(o.LOAD)):document.location.href=g()||t.absolute},M&&n&&(ne.onprogress=function(){return function(t){var e;return e=t.lengthComputable?t.loaded/t.total*100:M.value+(100-M.value)/10,M.advanceTo(e)}}(this)),ne.onloadend=function(){return ne=null},ne.onerror=function(){return document.location.href=t.absolute},ne.send()},S=function(t){return null!=ne&&ne.abort(),p(t.title,t.body),P(t),te(o.RESTORE)},h=function(){var t;return t=new n(E.url),q[t.absolute]={url:t.relative,body:document.body,title:document.title,positionY:window.pageYOffset,positionX:window.pageXOffset,cachedAt:(new Date).getTime(),transitionCacheDisabled:null!=document.querySelector("[data-no-transition-cache]")},m(d)},X=function(t){return null==t&&(t=d),/^[\d]+$/.test(t)?d=parseInt(t):void 0},m=function(t){var e,n,r,i,u,s;for(r=Object.keys(q),e=r.map(function(t){return q[t].cachedAt}).sort(function(t,e){return e-t}),s=[],i=0,u=r.length;u>i;i++)n=r[i],q[n].cachedAt<=e[t]&&(te(o.EXPIRE,q[n]),s.push(delete q[n]));return s},p=function(e,n,r,i){return te(o.BEFORE_UNLOAD),document.title=e,document.documentElement.replaceChild(n,document.body),null!=r&&t.update(r),z(),i&&k(),E=window.history.state,null!=M&&M.done(),te(o.CHANGE),te(o.UPDATE)},k=function(){var t,e,n,o,r,i,u,s,a,l,c,h;for(i=Array.prototype.slice.call(document.body.querySelectorAll('script:not([data-turbolinks-eval="false"])')),u=0,a=i.length;a>u;u++)if(r=i[u],""===(c=r.type)||"text/javascript"===c){for(e=document.createElement("script"),h=r.attributes,s=0,l=h.length;l>s;s++)t=h[s],e.setAttribute(t.name,t.value);r.hasAttribute("async")||(e.async=!1),e.appendChild(document.createTextNode(r.innerHTML)),o=r.parentNode,n=r.nextSibling,o.removeChild(r),o.insertBefore(e,n)}},Q=function(t){return t.innerHTML=t.innerHTML.replace(/<noscript[\S\s]*?<\/noscript>/gi,""),t},z=function(){var t,e;return t=(e=document.querySelectorAll("input[autofocus], textarea[autofocus]"))[e.length-1],t&&document.activeElement!==t?t.focus():void 0},G=function(t){return(t=new n(t)).absolute!==j?window.history.pushState({turbolinks:!0,url:t.absolute},"",t.absolute):void 0},U=function(){var t,e;return(t=ne.getResponseHeader("X-XHR-Redirected-To"))?(t=new n(t),e=t.hasNoHash()?document.location.hash:"",window.history.replaceState(window.history.state,"",t.href+e)):void 0},g=function(){var t;return null!=(t=ne.getResponseHeader("Location"))&&new n(t).crossOrigin()?t:void 0},K=function(){return j=document.location.href},$=function(){return window.history.replaceState({turbolinks:!0,url:document.location.href},"",document.location.href)},B=function(){return E=window.history.state},O=function(){var t;return navigator.userAgent.match(/Firefox/)&&!(t=new n).hasNoHash()?(window.history.replaceState(E,"",t.withoutHash()),document.location.hash=t.hash):void 0},P=function(t){return window.scrollTo(t.positionX,t.positionY)},Y=function(){return document.location.hash?document.location.href=document.location.href:window.scrollTo(0,0)},f=function(t){var e,n,o;if(null==t||"object"!=typeof t)return t;e=new t.constructor;for(n in t)o=t[n],e[n]=f(o);return e},D=function(t){var e,n;return e=(null!=(n=document.cookie.match(new RegExp(t+"=(\\w+)")))?n[1].toUpperCase():void 0)||"",document.cookie=t+"=; expires=Thu, 01-Jan-70 00:00:01 GMT; path=/",e},te=function(t,e){var n;return"undefined"!=typeof Prototype&&Event.fire(document,t,e,!0),n=document.createEvent("Events"),e&&(n.data=e),n.initEvent(t,!0,!0),document.dispatchEvent(n)},F=function(t){return!te(o.BEFORE_CHANGE,{url:t})},I=function(){var t,e,n,o,r,i;return e=function(){var t;return 400<=(t=ne.status)&&600>t},i=function(){var t;return ne.responseURL.match(/\.hbs$/)||null!=(t=ne.getResponseHeader("Content-Type"))&&t.match(/^(?:text\/html|application\/xhtml\+xml|application\/xml)(?:;|$)/)},o=function(t){var e,n,o,r,i;for(r=t.querySelector("head").childNodes,i=[],n=0,o=r.length;o>n;n++)e=r[n],null!=("function"==typeof e.getAttribute?e.getAttribute("data-turbolinks-track"):void 0)&&i.push(e.getAttribute("src")||e.getAttribute("href"));return i},t=function(t){var e;return R||(R=o(document)),e=o(t),e.length!==R.length||r(e,R).length!==R.length},r=function(t,e){var n,o,r,i,u;for(t.length>e.length&&(i=[e,t],t=i[0],e=i[1]),u=[],o=0,r=t.length;r>o;o++)n=t[o],re.call(e,n)>=0&&u.push(n);return u},!e()&&i()&&(n=y(ne.responseText),n&&!t(n))?n:void 0},_=function(e){var n;return n=e.querySelector("title"),[null!=n?n.textContent:void 0,Q(e.querySelector("body")),t.get(e).token,"runScripts"]},t={get:function(t){var e;return null==t&&(t=document),{node:e=t.querySelector('meta[name="csrf-token"]'),token:null!=e&&"function"==typeof e.getAttribute?e.getAttribute("content"):void 0}},update:function(t){var e;return e=this.get(),null!=e.token&&null!=t&&e.token!==t?e.node.setAttribute("content",t):void 0}},y=function(t){var e;return e=document.documentElement.cloneNode(),e.innerHTML=J(t),e.head=e.querySelector("head"),e.body=e.querySelector("body"),e},n=function(){function t(e){return this.original=null!=e?e:document.location.href,this.original.constructor===t?this.original:void this._parse()}return t.prototype.withoutHash=function(){return this.href.replace(this.hash,"").replace("#","")},t.prototype.withoutHashForIE10compatibility=function(){return this.withoutHash()},t.prototype.hasNoHash=function(){return 0===this.hash.length},t.prototype.crossOrigin=function(){return this.origin!==(new t).origin},t.prototype._parse=function(){var t;return(null!=this.link?this.link:this.link=document.createElement("a")).href=this.original,t=this.link,this.href=t.href,this.protocol=t.protocol,this.host=t.host,this.hostname=t.hostname,this.port=t.port,this.pathname=t.pathname,this.search=t.search,this.hash=t.hash,this.origin=[this.protocol,"//",this.hostname].join(""),0!==this.port.length&&(this.origin+=":"+this.port),this.relative=[this.pathname,this.search,this.hash].join(""),this.absolute=this.href},t}(),r=function(t){function e(t){return this.link=t,this.link.constructor===e?this.link:(this.original=this.link.href,this.originalElement=this.link,this.link=this.link.cloneNode(!1),void e.__super__.constructor.apply(this,arguments))}return ue(e,t),e.HTML_EXTENSIONS=["html"],e.allowExtensions=function(){var t,n,o,r;for(n=1<=arguments.length?se.call(arguments,0):[],o=0,r=n.length;r>o;o++)t=n[o],e.HTML_EXTENSIONS.push(t);return e.HTML_EXTENSIONS},e.prototype.shouldIgnore=function(){return this.crossOrigin()||this._anchored()||this._nonHtml()||this._optOut()||this._target()},e.prototype._anchored=function(){return(this.hash.length>0||"#"===this.href.charAt(this.href.length-1))&&this.withoutHash()===(new n).withoutHash()},e.prototype._nonHtml=function(){return this.pathname.match(/\.[a-z]+$/g)&&!this.pathname.match(new RegExp("\\.(?:"+e.HTML_EXTENSIONS.join("|")+")?$","g"))},e.prototype._optOut=function(){var t,e;for(e=this.originalElement;!t&&e!==document;)t=null!=e.getAttribute("data-no-turbolink"),e=e.parentNode;return t},e.prototype._target=function(){return 0!==this.link.target.length},e}(n),e=function(){function t(t){this.event=t,this.event.defaultPrevented||(this._extractLink(),this._validForTurbolinks()&&(F(this.link.absolute)||ee(this.link.href),this.event.preventDefault()))}return t.installHandlerLast=function(e){return e.defaultPrevented?void 0:(document.removeEventListener("click",t.handle,!1),document.addEventListener("click",t.handle,!1))},t.handle=function(e){return new t(e)},t.prototype._extractLink=function(){var t;for(t=this.event.target;t.parentNode&&"A"!==t.nodeName;)t=t.parentNode;return"A"===t.nodeName&&0!==t.href.length?this.link=new r(t):void 0},t.prototype._validForTurbolinks=function(){return null!=this.link&&!(this.link.shouldIgnore()||this._nonStandardClick())},t.prototype._nonStandardClick=function(){return this.event.which>1||this.event.metaKey||this.event.ctrlKey||this.event.shiftKey||this.event.altKey},t}(),i=function(){function t(t){this.elementSelector=t,this._trickle=ae(this._trickle,this),this.value=0,this.opacity=1,this.content="",this.speed=300,this.install()}var e;return e="turbolinks-progress-bar",t.prototype.install=function(){return this.element=document.querySelector(this.elementSelector),this.element.classList.add(e),this.styleElement=document.createElement("style"),document.head.appendChild(this.styleElement),this._updateStyle()},t.prototype.uninstall=function(){return this.element.classList.remove(e),document.head.removeChild(this.styleElement)},t.prototype.start=function(){return this.advanceTo(5)},t.prototype.advanceTo=function(t){var e;if(t>(e=this.value)&&100>=e){if(this.value=t,this._updateStyle(),100===this.value)return this._stopTrickle();if(this.value>0)return this._startTrickle()}},t.prototype.done=function(){return this.value>0?(this.advanceTo(100),this._reset()):void 0},t.prototype._reset=function(){return setTimeout(function(t){return function(){return t.opacity=0,t._updateStyle()}}(this),this.speed/2),setTimeout(function(t){return function(){return t.value=0,t.opacity=1,t._withSpeed(0,function(){return t._updateStyle(!0)})}}(this),this.speed)},t.prototype._startTrickle=function(){return this.trickling?void 0:(this.trickling=!0,setTimeout(this._trickle,this.speed))},t.prototype._stopTrickle=function(){return delete this.trickling},t.prototype._trickle=function(){return this.trickling?(this.advanceTo(this.value+Math.random()/2),setTimeout(this._trickle,this.speed)):void 0},t.prototype._withSpeed=function(t,e){var n,o;return n=this.speed,this.speed=t,o=e(),this.speed=n,o},t.prototype._updateStyle=function(t){return null==t&&(t=!1),t&&this._changeContentToForceRepaint(),this.styleElement.textContent=this._createCSSRule()},t.prototype._changeContentToForceRepaint=function(){return this.content=""===this.content?" ":""},t.prototype._createCSSRule=function(){return""+this.elementSelector+"."+e+"::before {\n  content: '"+this.content+"';\n  position: fixed;\n  top: 0;\n  left: 0;\n  z-index: 2000;\n  background-color: #0076ff;\n  height: 3px;\n  opacity: "+this.opacity+";\n  width: "+this.value+"%;\n  transition: width "+this.speed+"ms ease-out, opacity "+this.speed/2+"ms ease-in;\n  transform: translate3d(0,0,0);\n}"},t}(),c=function(t){return setTimeout(t,500)},C=function(){return document.addEventListener("DOMContentLoaded",function(){return te(o.CHANGE),te(o.UPDATE)},!0)},N=function(){return"undefined"!=typeof jQuery?jQuery(document).on("ajaxSuccess",function(t,e){return jQuery.trim(e.responseText)?te(o.UPDATE):void 0}):void 0},L=function(t){var e,o;return(null!=(o=t.state)?o.turbolinks:void 0)?(e=q[new n(t.state.url).absolute])?(h(),S(e)):ee(t.target.location.href):void 0},x=function(){return $(),B(),document.addEventListener("click",e.installHandlerLast,!0),window.addEventListener("hashchange",function(){return $(),B()},!1),c(function(){return window.addEventListener("popstate",L,!1)})},A=void 0!==window.history.state||navigator.userAgent.match(/Firefox\/2[6|7]/),a=window.history&&window.history.pushState&&window.history.replaceState&&A,u=!navigator.userAgent.match(/CriOS\//),V="GET"===(oe=D("request_method"))||""===oe,l=a&&u&&V,s=document.addEventListener&&document.createEvent,s&&(C(),N()),l?(ee=T,x()):ee=function(t){return document.location.href=t},this.Turbolinks={visit:ee,pagesCached:X,contentTransform:v,enableTransitionCache:b,enableProgressBar:w,allowLinkExtensions:r.allowExtensions,supported:l,EVENTS:f(o)}}).call(this);
...
var page=window.page={url:null,template:null,renderTarget:null,data:null,previewScrollX:null,previewScrollY:null,render:function(e,r){page.data=e||{};var a=$(document.createElement("div"));$(a).html(page.template(e)),page.renderTarget.replaceWith(a),page.renderTarget=a,(void 0===r||r)&&$(document).trigger("turbo:ready")}};$(document).on("page:fetch",function(e){page.url=e.originalEvent.data.url}),$(function(){var e=$("script#main[type='text/handlebars']");e.length>0&&(page.renderTarget=e,page.template=Handlebars.compile(e.html())),page.render(page.data,!1),null!==page.previewScrollX&&null!==page.previewScrollY&&window.scrollTo(page.previewScrollX,page.previewScrollY)}),Turbolinks.enableTransitionCache(),Turbolinks.enableProgressBar(),window.addEventListener("data",function(e){var r=document.documentElement||document.body.parentNode||document.body;page.previewScrollX=void 0!==window.pageXOffset?window.pageXOffset:r.scrollLeft,page.previewScrollY=void 0!==window.pageYOffset?window.pageYOffset:r.scrollTop,page.render(e.detail)});